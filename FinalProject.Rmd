...
(D) .Rmd Line number(s) for use of regular expressions: Note: part F has the regular expression
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions:135-149
...
(F) .Rmd Line number(s) for use of user-defined functions: 158-164
