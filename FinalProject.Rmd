...
```{r}
poopByNeighborhood<-
  left_join(wrangledPoop, wrangledBathroom, by=c('Neighborhood'='analysis_neighborhood'))%>%
  mutate(latitude.x=NULL,longitude.x=NULL,latitude.y=NULL,longitude.y=NULL, Address=NULL,)
...
```{r}
  availaibility<-
    poopByNeighborhood%>%
    group_by(access)%>%
    mutate(OBJECTID=NULL,Date=NULL,street=NULL,supervisor=NULL,policedistrict=NULL,CurrentPD=NULL,Neighborhoods=NULL,name=NULL,address=NULL,city=NULL,state=NULL,zip_code=NULL,park=NULL,public_access_hours_open=NULL,public_access_hours_close=NULL,public_access_days=NULL,point=NULL,supervisor_district=NULL,latitude.x=NULL,longitude.x=NULL,latitude.y=NULL,longitude.y=NULL)
  neighborhood<-
    poopByNeighborhood%>%
